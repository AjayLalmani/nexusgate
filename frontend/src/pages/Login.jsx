    ...
    <div className="min-h-screen flex items-center justify-center bg-darker px-4">
      <div className="max-w-md w-full glass-panel p-8 rounded-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Sign in to manage your API gateway</p>
        </div>
        ...
        <p className="text-center mt-6 text-slate-400 text-sm">
          Don't have an account? <Link to="/signup" className="text-primary hover:text-indigo-400 font-medium">Sign up</Link>
        </p>
      </div>
    </div>
  );
